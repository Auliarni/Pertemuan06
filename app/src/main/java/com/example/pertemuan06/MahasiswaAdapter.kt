...
import com.example.pertemuan06.databinding.ListItemBinding

class MahasiswaAdapter (private val context: Context, private var listMahasiswa : ArrayList<Mahasiswa>) :
